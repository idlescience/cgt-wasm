...
// clang-format on
    ...
    namespace
    {
        ...
        struct FatalConditionHandler
        {
            ...
            {
                // Multiple threads may enter this filter/handler at once. We want the error message to be printed on
                // the console just once no matter how many threads have crashed.
        ...
        struct ConsoleReporter : public IReporter
        {
            ...
            void test_run_end(const TestRunStats &p) override
            {
                ...
                auto totwidth = int(std::ceil(log10(
                    static_cast<double>(std::max(p.numTestCasesPassingFilters, static_cast<unsigned>(p.numAsserts))) +
                    1)));
                ...
                auto failwidth = int(std::ceil(log10(
                    static_cast<double>(std::max(p.numTestCasesFailed, static_cast<unsigned>(p.numAssertsFailed))) +
                    1)));
