...
/* set simplex solver iteration count */
    ...
    void glp_check_kkt(glp_prob *P, int sol, int cond, double *ae_max, int *ae_ind, double *re_max, int *re_ind);
    ...
    void glp_analyze_coef(glp_prob *P, int k, double *coef1, int *var1, double *value1, double *coef2, int *var2,
                          double *value2);
...
/* free the preprocessor workspace */
    ...
    int glp_ios_add_row(glp_tree *T, const char *name, int klass, int flags, int len, const int ind[],
...
#define glp_calloc(n, size) glp_alloc(n, size)
    ...
    int glp_mincost_relax4(glp_graph *G, int v_rhs, int a_low, int a_cap, int a_cost, int crash, double *sol, int a_x,
                           int a_rc);
